      ...
      <table class="fixed">
        ...
        <tr v-for="(item, $index) in list" :key="item.id">
          ...
          <td style="z-index: inherit;">
            ...
            <x-button type="warning" shape="circle" size="xsmall" data-toggle="tooltip" :title="$t('online tooltip')" @click="_poponline(item)" v-if="item.releaseState === 'OFFLINE'"  icon="ans-icon-upward"><!--{{$t('下线')}}--></x-button>
